...
class MessagingService:
    ...
    def validate_recipients(self, to: list[str], cc: list[str]) -> tuple[bool, str | None]:
        ...
        if bad:
            domains = ", ".join(self.settings.domain_allowlist) or "configured internal domains"
            return False, f"Outbound messages are restricted to internal recipients ({domains})."
        return True, None
