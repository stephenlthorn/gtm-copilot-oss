...
class GTMModuleService:
        ...
        *,
        ...
        if llm_payload is None:
            ...
            body = self.messaging.build_email_body(
                ...
                sources=[f"Call {call.chorus_call_id}" if call else "Internal notes"],
            )
        else:
        ...
        *,
        ...
        if llm_payload is None:
            payload = {
                ...
                "watchouts": [
                    "Unclear SLOs for replica freshness and long-running analytical scans",
    ...
    def marketing_intelligence(
        ...
        *,
        ...
        query = " ".join(["Platform GTM signals", *regions, *verticals]).strip()
    ...
    def rep_full_solution(
        ...
        *,
        ...
        automation_next_steps = [
            "Auto-run this full pack after each call sync.",
