    ...
    def _deep_research_pre_call(
        ...
        *,
        ...
        synthesize_prompt = (
            ...
            "Name, role, seniority signal. Only include fields present in research.\n\n"
            "## 3. Stack Hypothesis\n"
            "Use tiers — only include tiers with content:\n"
            "**Likely:** (supported by job postings, engineering blog, or research findings)\n"
            "**Possible:** (common pattern for this industry/scale)\n"
            "**Need to confirm on call:** (the one unknown that changes your pitch most)\n\n"
            "## 4. Pain Hypotheses\n"
            "2-3 pains. For each:\n"
            ...
            "## 8. Your One-Liner\n"
            "One sentence the rep can anchor the whole meeting on. Make it specific to this company.\n\n"
            "## 9. Next Action\n"
