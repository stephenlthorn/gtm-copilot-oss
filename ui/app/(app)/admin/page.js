...
const SAMPLE_AUDITS = [
  ...
  { id: '2', action: 'sync_calls', status: 'ok', actor: 'system', ts: '2026-02-19T10:05:00Z' },
  { id: '3', action: 'chat', status: 'ok', actor: 'rep.one@example.com', ts: '2026-02-19T10:12:00Z' },
  { id: '4', action: 'draft_message', status: 'ok', actor: 'se.one@example.com', ts: '2026-02-19T11:01:00Z' },
  { id: '5', action: 'chat', status: 'error', actor: 'rep.two@example.com', ts: '2026-02-19T11:45:00Z' },
];

const SAMPLE_DOCS = [
  { title: 'Distributed SQL GTM Positioning Playbook', source_type: 'google_drive', source_id: 'drive_001', modified_time: '2026-02-18' },
  { title: 'HTAP Sizing FAQ', source_type: 'google_drive', source_id: 'drive_002', modified_time: '2026-02-18' },
    ...
    <>
      ...
      <div className="content">
        <div className="kpi-row">
            ...
            { label: 'Calls Indexed', value: FAKE_CALLS.length, sub: 'Asteria · Northwind · Summit' },
