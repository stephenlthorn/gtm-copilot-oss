...
def test_redaction_masks_common_sensitive_fields():
    text = "Email me at rep@example.com, call +1 415-555-1212, card 4111 1111 1111 1111"
...
def test_llm_fail_closed_when_api_key_missing(monkeypatch):
    ...
    monkeypatch.setenv("OPENAI_BASE_URL", "https://llm.internal.example")
    monkeypatch.setenv("SECURITY_ALLOWED_LLM_BASE_URLS", "https://llm.internal.example")
